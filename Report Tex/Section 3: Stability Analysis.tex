...
\vspace*{\fill}
\columnbreak{}
\includegraphics[width=0.5\textwidth]{Stability Regions/Graphs/Real 1-Step/Euler's Forward.png} 
\end{multicols}

\subsubsection{Stability Region for Euler's Backward Method}
\begin{multicols}{2}
\includegraphics[width=0.5\textwidth]{Stability Regions/Graphs/Real 1-Step/Euler's Backward.png}
\columnbreak{}
\vspace*{\fill}
...
\vspace*{\fill}
\columnbreak{}
\includegraphics[width=0.5\textwidth]{Stability Regions/Graphs/Real 1-Step/Runge-Kutta 4.png}
\end{multicols}
